...
<script>
	...
	$('#new_leave').click(function(){
		uni_modal("New Permission Type","manage_leave_type.php")
	})
	
	$('.edit_leave_type').click(function(){
		uni_modal("Edit Permission Type","manage_leave_type.php?id="+$(this).attr('data-id'))
		
	})
	$('.delete_leave_type').click(function(){
		_conf("Are you sure to delete this Permission Type?","delete_leave_type",[$(this).attr('data-id')])
	})
