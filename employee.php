...
<script>
	...
	$('.edit_employee').click(function(){
		uni_modal("Edit Student","manage_employee.php?id="+$(this).attr('data-id'),"mid-large")
	...
	$('.delete_employee').click(function(){
		_conf("Are you sure to delete this Student/Staff?","delete_employee",[$(this).attr('data-id')])
	})
