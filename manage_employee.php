		...
		<hr>
			...
			<div class="row form-group">
				...
				<div class="col-md-4">
					...
					<select name="type" id="type" class="custom-select" required="">
						...
						<option value="3" <?php echo isset($type) && $type == 3 ? "selected" :'' ?>>Mentor</option>
						<option value="4" <?php echo isset($type) && $type == 4 ? "selected" :'' ?>>Coordinator</option>
			...
			<div class="row form-group" id="man_sup">
				<div class="col-md-4" id="man-field">
					<label for="" class="control-label">Mentor</label>
			...
			success:function(resp){
				if(typeof resp != undefined){
					...
					if(Object.keys(resp).length > 0){
						...
						$("#manager_id").html('<option value="" disabled="" selected="">No Mentor is listed under selected department</option>')
					}
				}
			},
		})
