...
extract($_POST);
$etype = array("","Principal","Department Head","Mentor","Coordinator","Regular");
...
<div class="container-fluid">
	<div class="col-lg-12">
		<div class="row">
			<div class="col-md-6">
				<p>Student ID: <b><?php echo $employee_id ?></b></p>
			...
			<div class="col-md-6">
				...
				<p>Mentor: <b><?php echo $manager_id > 0 ? ucwords($ename[$manager_id]) : "N/A" ?></b></p>
				<p>Coordinator: <b><?php echo $supervisor_id > 0 ? ucwords($ename[$supervisor_id]) : "N/A" ?></b></p>
